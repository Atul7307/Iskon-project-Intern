...
const BookKirtanForm = () => {
  return (
    <div className="flex flex-col md:flex-row bg-white shadow-lg rounded-lg overflow-y-auto overflow-x-hidden md:overflow-y-hidden h-[500px] md:h-auto">
      {/* Left Side - Image */}

      <div className="w-full md:w-[40%] h-[400px] md:h-[560px]">
        <img
          src={img1}
      ...
      {/* Right Side - Form */}
      <div className="w-[full] md:w-[60%] px-6 py-2 flex flex-col justify-start items-start">
        <h2 className="text-[#1b1616] text-2xl font-bold font-['Poppins'] m-0">
          Book a Kirtan at Home
          <hr
        ...
        <p className="text-[#7f7a7a] text-sm font-normal font-['Open Sans'] text-start  mb-2">
          Let your home reverberate with the Holy name, make a special occasion,
          a divine occasion by marking it with a sankirtan where devotees from
          the Iskcon Vijayawada temple will come to you and sing the glories of
          the Lord.
        </p>
